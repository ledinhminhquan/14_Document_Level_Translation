"""Translation metrics: chrF (headline) + BLEU, via sacrebleu when available with
self-contained pure-python fallbacks so metrics compute with no heavy deps. (Reused from
P13 s2st.) Structure-preservation metrics live in ``docparse/structure_score.py``.
"""
...
__all__ = ["chrf", "bleu", "wer", "translation_metrics"]
